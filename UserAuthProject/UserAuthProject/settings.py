...
SECRET_KEY = 'django-insecure-$j%wc8#e6*^4c-)bi(x1n!khu$ug4#gfc3wp+rm^&sb)6hovb!'
...
AUTH_USER_MODEL = 'AccountsApp.User' # application.customUserModel 
...
# set time Limit for token  

PASSWORD_RESET_TIMEOUT = 600  #600 seconds 10 min
